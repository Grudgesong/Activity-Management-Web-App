    ...
    onMutate: async (activityId: string) => {
      ...
      queryClient.setQueryData<Activity>(['activities', activityId], oldActivity => {
        ...
        return {
          ...
          attendees: isAttending ? isHost ? oldActivity.attendees : oldActivity.attendees.filter(x=> x.id !== currentUser.id) : [...oldActivity.attendees, {
            id: currentUser.id,
